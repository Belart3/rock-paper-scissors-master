...
rock.addEventListener("click", function(){
    ...
    setTimeout(function(){
        ...
        if (player.className == 'player rock' && computer.className == 'computer spock') {
            playerScore;
            computerScore++;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
        ...
        if (player.className == 'player rock' && computer.className == 'computer lizard') {
            playerScore++;
            computerScore;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
...
paper.addEventListener("click", function(){
    ...
    setTimeout(function(){
        ...
        if (player.className == 'player paper' && computer.className == 'computer spock') {
            playerScore++;
            computerScore;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
        ...
        if (player.className == 'player paper' && computer.className == 'computer lizard') {
            playerScore;
            computerScore++;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
...
scissors.addEventListener("click", function(){
    ...
    if (player.className == 'player scissors' && computer.className == 'computer lizard') {
        playerScore++;
        computerScore;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
    ...
    if (player.className == 'player scissors' && computer.className == 'computer spock') {
        playerScore;
        computerScore++;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
...
spock.addEventListener("click", function(){
    ...
    if (player.className == 'player spock' && computer.className == 'computer paper') {
    playerScore;
    computerScore++;
    score.innerHTML = playerScore;
    aIScore.innerHTML = computerScore;
    ...
    if (player.className == 'player spock' && computer.className == 'computer scissors') {
        playerScore++;
        computerScore;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
    ...
    if (player.className == 'player spock' && computer.className == 'computer rock') {
        playerScore++;
        computerScore;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
    ...
    if (player.className == 'player spock' && computer.className == 'computer spock') {
        playerScore;
        computerScore;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
    ...
    if (player.className == 'player spock' && computer.className == 'computer lizard') {
        playerScore;
        computerScore++;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
...
lizard.addEventListener("click", function(){
    ...
    setTimeout(function(){
        ...
        if (player.className == 'player lizard' && computer.className == 'computer spock') {
        playerScore++;
        computerScore;
        score.innerHTML = playerScore;
        aIScore.innerHTML = computerScore;
        ...
        if (player.className == 'player lizard' && computer.className == 'computer paper') {
            playerScore++;
            computerScore;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
        ...
        if (player.className == 'player lizard' && computer.className == 'computer rock') {
            playerScore;
            computerScore++;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
        ...
        if (player.className == 'player lizard' && computer.className == 'computer scissors') {
            playerScore;
            computerScore++;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
        ...
        if (player.className == 'player lizard' && computer.className == 'computer lizard') {
            playerScore;
            computerScore;
            score.innerHTML = playerScore;
            aIScore.innerHTML = computerScore;
...
replay.addEventListener("click", function(){
    ...
    player.classList.remove("spock");
    player.classList.remove("lizard");
    computer.classList.remove("paper");
    computer.classList.remove("rock");
    computer.classList.remove("scissors");
    computer.classList.remove("spock");
    computer.classList.remove("lizard");
